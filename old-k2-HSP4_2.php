				...
				<div class="box">
					...
					<div class="vidoes">
					   ...
					   <table>
						...
						display_source1($k2_HSP42_notebook_photo_list, $k2_HSP42_notebook_real_list, $k2_HSP42_notebook_name_list,"notebook");
                       				?>
				...
				<div class="box">
					...
					<div class="vidoes">
					   ...
					   <table>
					      	...
					      	require_once("source_display.php");
						include "videos_games_arrays.php";
						display_source1($k2_HSP42_videos_photo_list, $k2_HSP42_videos_real_list, $k2_HSP42_videos_name_list,"video");
                       				?>
