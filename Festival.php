			...
			<div id="content">
				...
				<div class="box">
					...
					<form name='videoplay' method='post' action='public/playvideo.php'>
					   <table>
					      ...
					      display_source($Halloween_videos_photo_list, $Halloween_videos_real_list, $Halloween_videos_name_list);
		      ...
		      <table>
		            <?php
					      include "videos_games_arrays.php";
					      require_once("public/source_display.php");
					      display_source($Christmas_videos_photo_list, $Christmas_videos_real_list, $Christmas_videos_name_list);
