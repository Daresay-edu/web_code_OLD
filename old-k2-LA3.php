			...
			<div id="content">
				...
				<div class="box">
					...
					<div class="vidoes">
						...
						display_source1($k2_LA3_photo_list, $k2_LA3_real_list, $k2_LA3_name_list,"video");
                       				?>
		      ...
		      <?php
		      	include "videos_games_arrays.php";
			require_once("source_display.php");
			display_source($k2_LA3_games_photo_list, $k2_LA3_games_real_list, $k2_LA3_games_name_list);
