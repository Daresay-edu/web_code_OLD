...
<div id="container">
	<div class="shell">
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<form name='videoplay' method='post' action='public/playvideo.php'>
					   <table>
                       			      <?php
					      include "new_k1_videos_games_arrays.php";
					      require_once("public/source_display.php");
					      display_source($k1_unit1_videos_photo_list, $k1_unit1_videos_real_list, $k1_unit1_videos_name_list);
			...
			require_once("public/source_display.php");
			display_source($k1_unit1_games_photo_list, $k1_unit1_games_real_list, $k1_unit1_games_name_list);
