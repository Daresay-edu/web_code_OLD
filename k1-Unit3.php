				...
				<div class="box">
					...
					<div class="vidoes">
					   ...
					   <table>
						...
						$root_dir="../teach_source/K1/Unit3/";
						$type="notebook";
				...
				<div class="box">
					...
					<div class="vidoes">
					 ...
					 <form name='videoplay' method='post' action='public/playvideo.php'>
					   ...
					   require_once("public/source_display.php");
					   display_source($k1_unit3_videos_photo_list, $k1_unit3_videos_real_list, $k1_unit3_videos_name_list);
				...
				<div class="box">
					...
					<div class="vidoes">
                      ...
                      <br/>
					   ...
					   include "videos_games_arrays.php";
					   require_once("public/source_display.php");
					   display_source($k1_unit3_games_photo_list, $k1_unit3_games_real_list, $k1_unit3_games_name_list);
