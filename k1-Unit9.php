			...
			<div id="content">
				...
				<div class="box">
					...
					<div class="vidoes">
					   ...
					   <table>
						...
						$root_dir="../teach_source/K1/Unit9/";
						$type="notebook";
				...
				<div class="box">
					...
					<div class="vidoes">
					   ...
					   require_once("public/source_display.php");
					   display_source($k1_unit9_videos_photo_list, $k1_unit9_videos_real_list, $k1_unit9_videos_name_list);
				...
				<div class="box">
					...
					<div class="vidoes">
                      ...
                      <br/>
					   ...
					   include "videos_games_arrays.php";
					   require_once("public/source_display.php");
					   display_source($k1_unit9_games_photo_list, $k1_unit9_games_real_list, $k1_unit9_games_name_list);
