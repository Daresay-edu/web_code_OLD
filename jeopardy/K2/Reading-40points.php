...
<br/><br/>
<?php
	$question="Can you read this book?<br/>
Going on Vacation <br/>
We put the bags in the car.<br/>
We put the toys in the car.<br/>
We put the blankets in the car.<br/>
We put the balls in the car.<br/>
We put the bears in the car.<br/>
We put the food in the car.<br/>
We put the dogs in the car.<br/>
Goodbye!";
	$answer="";
	$img1="null";
	$img2="null";
...
<table>
	...
	?>
		<tr>
			<td align='center'> 
			<img src='<?php echo $img1;?>' width='560px' height='560px'/>
		</td>
		</tr>
	<?php }?>
	<?php
	...
	?>
		<tr>
			<td align='center'> 
			<img src='<?php echo $img2;?>' width='560px' height='560px'/>
		</td>
		</tr>
	<?php }?>
	<tr id='checkanswer'>
