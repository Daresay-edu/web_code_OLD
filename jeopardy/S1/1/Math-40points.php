...
<br/><br/>
<?php
	$question="Where is the cat? Can you describe <br/>it with prepositions of location?";
	$answer="The cat is in the box. <br/>The cat is behind the box.<br/>The cat is in front of the box.";
?>
<table>
	<tr>
	...
	<tr>
		<td align='center'> 
			<img src='image/Math-40points.png' width='560px' height='260px'/>
		</td>
	</tr>
	<tr id='checkanswer'>
		<td align='center' >
