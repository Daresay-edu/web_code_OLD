...
<br/><br/>
<?php
	$question="Can you speak out a noun, a verb, an adjective? <br/>";
	$answer="Noun: people, animals, things,  places;<br/>
Verb: hop, play, jog, hit...<br/>
Adjective: round, curved, big, small, red, yellow, one,<br/> two... (Adjectives to describe shape, size, color, number)<br/>";
?>
<table>
	<tr>
